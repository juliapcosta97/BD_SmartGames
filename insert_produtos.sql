...
insert into tblusuario(nome,login,senha) values ("Julia","juliapcosta97@gmail.com","123");


insert into tblloja (logradouro,numero,cidade, nomeReferencia) values ("Avenida Paulista","1500","São Paulo","Paulista");

insert into tblgame (nome,descricao,preco,classificacao,imagem,desenvolvedor,plataforma,genero,codloja) 
values ("Mortal Combat", "Mortal Kombat X é o próximo capítulo da esperada, lendária e aclamada franquia de jogos de luta da NetherRealm Studios, marcando a estreia da icônica série na nova geração. O jogo combina apresentação cinematográfica com jogabilidade inédita, oferecendo a mais brutal experiência de combate de todos os tempos, trazendo uma nova experiência completamente conectada que arremessa jogadores em uma competição online persistente, na qual toda luta conta na batalha global pela supremacia.

Pela primeira vez, Mortal Kombat X dá aos jogadores a habilidade de escolher entre múltiplas variações de cada personagem, afetando tanto a estratégia quanto o estilo de luta deles. Jogadores mergulham em uma trama original, que dá destaque para alguns dos personagens mais prolíficos do game como Scorpion e Sub-Zero, além de apresentar novos desafiantes que representam as forças do bem e do mal, amarrando o enredo.",
200.00,"+18", "conteudo/imagens/mortal_kombat.jpg","NetherRealm", "Xbox One","Luta",1);

insert into tblgame (nome,descricao,preco,classificacao,imagem,desenvolvedor,plataforma,genero,codloja) 
values ("FIFA 17", "Com a tecnologia Frostbite, o FIFA 17 transforma a maneira de jogar, competir e se conectar emocionalmente ao jogo. O game insere você em experiências de futebol autênticas, trazendo jogadores de futebol cheios de profundidade e emoção e levando você a mundos novos e exclusivos do jogo. Você domina cada momento em campo com inovação total na maneira com que os jogadores pensam, se movimentam, interagem fisicamente com os adversários e executam ataques. ",
200.00,"+18", "conteudo/imagens/fifa_17.jpg","EA", "Xbox One","Esporte",1);

insert into tblgame (nome,descricao,preco,classificacao,imagem,desenvolvedor,plataforma,genero,codloja) 
values ("Star Wars Battlefront", "É um jogo de acção de tiro na primeira e na terceira pessoa, produzido pela EA Digital Illusions CE (DICE) e baseado na franquia Star Wars. Foi publicado pela Electronic Arts com a chancela da LucasArts a 17 de Novembro de 2015 para Microsoft Windows, PlayStation 4 e Xbox One. Star Wars Battlefront é o terceiro título principal da série Battlefront, depois de Battlefront (2004) e Battlefront II (2005).
...
200.00,"+16", "conteudo/imagens/battlefield.jpg","EA", "Xbox One","Ação",1);
